    ...
    return (
        <div className={`relative ${isRight ? "mt-16" : "mb-12"} ${className}`}>
            ...
            <motion.hr
                ...
                className={`border-0 h-0.5 bg-black ${isRight ? "origin-right" : "origin-left" }`}
            />
            ...
            <motion.div
                ...
                className={`absolute top-0 w-full h-10 bg-no-repeat pointer-events-none origin-top ${isRight ? "bg-right" : "bg-left" }`}
                style={{
                    backgroundImage: `url("${spiderUrl}")`,
                    backgroundPosition: isRight
                        ? "right 10px top"
                        : "10px top",
                }}
            />
