...
export default function SpeechBubbleMenu() {
    ...
    const scale = width ? Math.min(Math.max(width / BASE_WIDTH, 0.6), 1) : 1;
    ...
    return (
        <div ref={ref} className="relative w-full h-full bg-[#2fc7f0] overflow-hidden z-0">
            <motion.nav
                className="w-full h-full max-w-3xl mx-auto font-[Georgia] text-sm px-6 py-3"
                role="navigation"
            ...
            >
                ...
                <motion.ul
                    ref={navRef}
                    className="hidden md:flex items-center gap-x-6 gap-y-2 whitespace-nowrap justify-center"
                    role="menubar"
                >
                    <AnimatePresence>
