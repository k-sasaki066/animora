...
export default function BackgroundMovesButton() {
    ...
    return (
        <motion.button
            className="px-8 py-4 rounded-sm border-3 font-bold bg-transparent border-neutral-200 text-neutral-400 transition-all duration-300 w-40 h-12 cursor-pointer flex justify-center items-center"
            initial={{
